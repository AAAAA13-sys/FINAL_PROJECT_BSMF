...
<body class="{{ Route::is('login') || Route::is('register') ? 'auth-page' : '' }}">
    <nav>
        <a href="{{ route('home') }}" class="logo">BSMF <span class="logo-accent">GARAGE</span></a>
        ...
        <ul class="nav-links">
            ...
            <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn">THE GARAGE <i class="fas fa-chevron-down dropdown-chevron"></i></a>
            ...
            @else
                ...
                <li><a href="{{ route('register') }}" class="btn btn-primary btn-nav-join">JOIN</a></li>
            @endauth
        </ul>
    </nav>
