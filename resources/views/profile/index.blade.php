...
<section class="section-padding">
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <p class="text-white opacity-50" style="margin-bottom: 4rem; text-transform: uppercase; font-style: italic;">Manage your account settings and security</p>

        <div class="auth-container fade-in" style="padding: 4rem; width: 100%; max-width: none;">
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">Full Name</label>
                            <input type="text" name="name" class="form-control bg-dark border-secondary text-white" value="{{ $user->name }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">Email Address</label>
                            <input type="email" name="email" class="form-control bg-dark border-secondary text-white" value="{{ $user->email }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">Phone Number</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">Default Shipping Address</label>
                ...
                <p class="text-white opacity-75 small mb-4">Update your credentials. Leave blank to keep current password.</p>

                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">New Password</label>
                            <div class="position-relative">
                                <input type="password" name="password" class="form-control bg-dark border-secondary text-white pe-5" placeholder="••••••••">
                                <button type="button" class="btn position-absolute top-50 end-0 translate-middle-y text-secondary border-0 bg-transparent py-0 pe-3" onclick="togglePassword(this)">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="text-secondary small text-uppercase fw-bold mb-2">Confirm New Password</label>
                            <div class="position-relative">
